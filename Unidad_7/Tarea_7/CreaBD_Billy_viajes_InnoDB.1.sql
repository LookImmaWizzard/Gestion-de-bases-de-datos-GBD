...
-- Diseño de la base de datos billy_viajes_InnoDB empleado en la tarea de la unidad 07
-- ------------------------------------------------------------------------------

/*Borramos, si existe, una base de datos anterior */

DROP DATABASE IF EXISTS billy_viajes_innodb;
--
-- Base de datos: VIAJES
-- Se crea la base de datos vacía;
CREATE DATABASE billy_viajes_innodb; 
;
