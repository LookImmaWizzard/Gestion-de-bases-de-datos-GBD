...
--
-- Current Database: `billy_viajes_myisam`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `billy_viajes_myisam` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
INSERT INTO `categoria` VALUES ('CRUC','Crucero'),('SAFA','Safari'),('EURO','Europa'),('LATI','Latinoamérica'),('ASIA','Asia');
...
INSERT INTO `cliente` VALUES ('23727319S','Belén Sánchez Pardo','bsp@gmail.com','2020-02-24',100),('43229482E','Ana Moreno López','aml@gmail.com','2019-03-15',50),('62877137F','Eva Luque Martínez','elm@gmail.com','2010-04-20',20),('74381725T','Francisco Ojeda Rodríguez','for@gmail.com','2022-06-24',30),('10101010X','pruebasX','pruebasx@gmail.com','2016-01-20',0),('20202020y','pruebasY','pruebasy@gmail.com','2017-11-10',0);
...
INSERT INTO `mayorista` VALUES ('CLA','Claratours'),('SAK','Saki Cruceros'),('SOL','Soltours'),('MEN','Mentetours'),('PIK','Piki Cruceros');
...
-- Dump completed on 2023-05-03 13:50:38
